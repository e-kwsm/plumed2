...
DynamicReferenceRestraining::DynamicReferenceRestraining(
  ...
  : PLUMED_BIAS_INIT(ao), firsttime(true), nobias(false),
    ...
    biasforceValue(getNumberOfArguments(), nullptr),
    springforceValue(getNumberOfArguments(), nullptr),
    fictValue(getNumberOfArguments(), nullptr),
    vfictValue(getNumberOfArguments(), nullptr),
    fictNoPBCValue(getNumberOfArguments(), nullptr),
    externalForceValue(getNumberOfArguments(), nullptr),
    externalFictValue(getNumberOfArguments(), nullptr),
